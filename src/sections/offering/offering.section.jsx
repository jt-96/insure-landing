    ...
    <>
      <div className="py-40">
        <div className="flex flex-col items-center lg:items-start lg:mx-20">
          ...
          <h2 className="mt-10 mb-20 text-4xl lg:text-5xl">We're different</h2>
        </div>

        <div className="px-10 mb-40 lg:flex lg:px-20">
          <div className="flex flex-col items-center text-center my-10 lg:items-start lg:pr-5">
            ...
            <p className="my-2 px-3 lg:text-left lg:px-0">
        ...
        <div className="relative flex flex-col bg-[#2c2640] mx-5 py-15 lg:mx-20">
